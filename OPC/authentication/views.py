...
def register_view(request): 
    ...
    if request.method == 'POST' and form.is_valid():
        try:
            ...
            activation_url = f"http://46.101.145.147/activate-registration/{temp_token}/"
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                reset_url = f"http://46.101.145.147/password-reset-confirm/{user.pk}/{default_token_generator.make_token(user)}/"
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                reminder_url = f"http://46.101.145.147/reset_username_confirmation_view/{user.pk}/{default_token_generator.make_token(user)}/"
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                ...
                deletion_url = f"http://46.101.145.147/delete-account-confirm/{user.pk}/{default_token_generator.make_token(user)}/"
